  ...
  return (
    ...
    >
      <Wrapper className={`h-[60px] flex justify-between items-center`}>
        <Link href="/">
          <img src="/logo.svg" alt="" className="w-[40px] md:w-[50px]" />
        </Link>
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          <div className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.5] cursor-pointer relative">
            ...
            <div className="h-[14px] md:h-[24px] min-w-[14px]  md:min-w-[18px]  rounded-full bg-red-600 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-[12px] flex justify-center items-center px-[2px] md:px-[5px]">
              9
            </div>
          </div>
          {/* icon End */}
